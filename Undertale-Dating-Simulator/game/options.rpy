...
init -1 python hide:
    ...
    config.window_title = u"Undertale Dating Simulator (Demo)"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Undertale Dating Simulator (Demo)"
    config.version = "0.0"
    ...
    config.main_menu_music = "audio/music-intro.mp3"
...
python early:
    config.save_directory = "Undertale Dating Simulator (Demo)-1461268408"
